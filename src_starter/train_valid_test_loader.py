...
def load_train_valid_test_datasets(
    ...
    try:
        ...
        all_df = pd.read_csv(os.path.join(data_path, "ratings_all_development_set.csv"))
    L = all_df.shape[0]
    ...
    for dtuple in [all_data_tuple, train_data_tuple, valid_data_tuple, test_data_tuple]:
